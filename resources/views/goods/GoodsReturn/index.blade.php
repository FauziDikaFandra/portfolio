...
<div class="starter-template mt-3  shadow p-3 mb-2 bg-white rounded">
    ...
    <form action="{{url('/goods/goods-return/view')}}" method="post">
...
<div class="table-responsive mt-3  shadow p-3 mb-5 bg-white rounded">
    <a class="btn btn-primary btn-sm mb-2" href="/goods/goods-return/create"><span class="mr-2" data-feather="plus"></span>Add New</a>
    <table class="table table-striped table-sm">
        <thead>
            <tr>
                <th width="150px">RT Code</th>
            ...
            <tr>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <a class="dropdown-item" href="/goods/goods-return/{{$gr->rt_code}}" <?= ($gr->status != 'OPEN') ? 'hidden' : '' ?>><span class="mr-2" data-feather="edit"></span>Edit</a>
                            <a class="dropdown-item" href="/goods/goods-return-details/{{$gr->rt_code}}"><span class="mr-2" data-feather="file-text"></span>Details</a>
                            <a class="dropdown-item" href="/goods/goods-return/delete/{{$gr->rt_code}}" <?= ($gr->status != 'OPEN') ? 'hidden' : '' ?>><span class="mr-2" data-feather="delete"></span>Delete</a>
                        </div>
                    </div>
                </td>
            </tr>

...
<header class="masthead bg-primary text-white text-center">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
        ...
        <img class="masthead-avatar rounded-circle mb-3" src="photo.png" alt="" />
        <!-- Masthead Heading-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">Development - Data Analyst - IT Manager</p>
    </div>
</header>
<!-- Portfolio Section-->
<section id="featured-services" class="featured-services">
    <div class="container" data-aos="fade-up">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Web Project</h2>
        <!-- Icon Divider-->

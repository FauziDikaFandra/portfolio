...
<body>
    ...
    <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top">
        <div class="container d-flex">
            <div class="contact-info mr-auto">
                <i class="icofont-envelope"></i> <a href="mailto:contact@example.com">fauzi.dika@gmail.com</a>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="index.html">Fauzi Dika Fandra<span>.</span></a></h1>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1><img src="logo.png" alt="my logo"> Welcome to <span>My Website</spa>
            </h1>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
                        <h3>The last 12 years in the Information Technology (IT) field in several Company..</h3>
                        <p class="font-italic">
                            During my work as an IT part of several companies, I was used to working in teams, either as a member or team leader.
                        </p>
                        <ul>
                            <li>
                        ...
                        <p>
                            Besides programming, I am also an expert in leading, able to analyze data, troubleshoot software and hardware, solve problems related to information technology
                        </p>
                    </div>
                </div>
